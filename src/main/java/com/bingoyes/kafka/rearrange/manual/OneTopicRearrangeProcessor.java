...
public class OneTopicRearrangeProcessor extends Thread {
    ...
    public void doAssignWindowFor(MessageRecord messageRecord){
        ...
        ProcessorWindow processorWindow = getWindow(windowsStart);
    ...
    public ProcessorWindow getWindow(long windowId){
        ...
        public void run(){
            while(true){
                ...
                for(int i= windowArray.length-1;i>=0;i--){
                    ...
                    long aheadWindowNum = (processorWindow.getStartTime()-context.getSlowestThreadWindowId())/windowSize;
                    if(watermark>= processorWindow.getEndTime() && aheadWindowNum<=context.getAllowMaxAHeadWindowNum()){
                        ...
                        if(context.getSlowestThreadIndex() ==threadIndex){
                           ...
                           context.setSlowestThreadWindowId(slowestThread.getLatestProcessedWindowId());
                        }
